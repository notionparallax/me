...
def dictionary_please() -> dict:
    ...
    my_dict = {"Name": "Wakanda", "slogan": "Forever"}
    return my_dict
...
def fast_filler(number_of_words=200) -> str:
    ...
    # Ensure the first two characters are an uppercase letter and a lowercase letter
